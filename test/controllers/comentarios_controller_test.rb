...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { comentario: @comentario.comentario, email: @comentario.email, nombre: @comentario.nombre, post_id: @comentario.post_id }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { comentario: @comentario.comentario, email: @comentario.email, nombre: @comentario.nombre, post_id: @comentario.post_id }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
